...
contract CollabifyPass is ERC1155, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    mapping(address => bool) private _affiliateList;
    ...
    function addAffiliates(address[] memory _newAffiliates) public isApproved{
        for(uint256 i= 0; i<_newAffiliates.length; i++){
            _affiliateList[_newAffiliates[i]] = true;
        }
